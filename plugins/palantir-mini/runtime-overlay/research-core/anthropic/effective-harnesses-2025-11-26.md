...
topic: "Effective harnesses for long-running agents — initializer + coding agent two-fold solution to bridge multiple context windows in the Claude Agent SDK"
---

# Effective harnesses for long-running agents

> Published Nov 26, 2025 by Justin Young, Anthropic Engineering.
> Source: https://www.anthropic.com/engineering/effective-harnesses-for-long-running-agents
> Cited by `~/.claude/rules/CONTEXT.md §15 Glossary` as canonical 1차 자료 on Claude Agent SDK harness species behavior across many context windows.
...
> *(Original article includes animated GIF showing browser-automated testing.)*
...
- Cited by rule 16 v4.0.0 §0 (5 harness species) as evidence for **Claude Agent SDK harness species** characteristics.
- Cited by `CONTEXT.md §15 Glossary` for canonical multi-context-window harness pattern.
- Companion piece to: Lance Martin "Scaling Managed Agents" (2026-04-08) + Prithvi Rajasekaran "Harness design for long-running application development" (2026-03-24). All three together form the Anthropic 1차 자료 trio for harness taxonomy.
- The "two-agent" pattern (initializer + coding) is a Claude Agent SDK species pattern; not to be conflated with palantir-mini-sprint-harness's separate Planner/Generator/Evaluator roles (rule 16 v3.1.0+).
