---
sourceUrl: "https://www.palantir.com/docs/apollo/apollo-cli/apollo-cli_module_evaluate/"
canonicalUrl: "https://palantir.com/docs/apollo/apollo-cli/apollo-cli_module_evaluate/"
sourceLastmod: "2026-05-12T17:06:26.160Z"
fetchedAt: "2026-05-12T23:57:50.244Z"
fetcher: "palantir-mini import-palantir-official-docs"
extractor: "next-data-markdown"
contentHash: "fd87fccefc17845f7a523570fdaf9343352ae22189cf53ab39418ba345256ab4"
product: "apollo"
docsArea: "apollo-cli"
locale: "en"
upstreamTitle: "Documentation | Apollo CLI > apollo-cli module evaluate [Experimental]"
licenseNote: "Local evidence mirror of public Palantir documentation. Use for routing and citation; do not republish as a standalone corpus."
---
<!-- This file is auto-generated in the apollo-cli repo by ./godelw generate. Do not update manually! -->

# apollo-cli module evaluate \[Experimental]
...
Evaluates a module definition to predict how it could behave when installed

Use --feature product-dependencies to evaluate the outbound direct product dependencies of every product in the module
(including submodules) and checks if they are fulfilled by the module.

```bash
apollo-cli module evaluate [flags]
```
...
| Flag                      | Use                      |
| ------------------------- | ------------------------ |
| `--feature` | Feature of a module to evaluate (supported features: product-dependencies) |
