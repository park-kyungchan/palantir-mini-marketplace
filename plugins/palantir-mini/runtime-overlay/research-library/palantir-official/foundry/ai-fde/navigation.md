---
sourceUrl: "https://www.palantir.com/docs/foundry/ai-fde/navigation/"
canonicalUrl: "https://palantir.com/docs/foundry/ai-fde/navigation/"
sourceLastmod: "2026-05-12T17:06:26.146Z"
fetchedAt: "2026-05-12T23:57:50.244Z"
fetcher: "palantir-mini import-palantir-official-docs"
extractor: "next-data-markdown"
contentHash: "a110def27e06139d0e0886ffaf8288e0eff80838f7ae31cf38c306ee66081adc"
product: "foundry"
docsArea: "ai-fde"
locale: "en"
upstreamTitle: "Documentation | AI FDE > Navigation"
...
![The AI FDE input field.](/docs/resources/foundry/ai-fde/ai-fde-input-field.png)

Sessions can be managed in the top toolbar, where you can create a new session and manage existing sessions.

![The AI FDE Session management menu.](/docs/resources/foundry/ai-fde/ai-fde-session-manager.png)
...
* Select a mode from the **Modes** menu above the input field. Depending on the mode, additional configurations are available, such as the language you want to use for functions, or whether you want to use transforms instead of Pipeline Builder. <br><br>
  ![the AI FDE Mode selector above the input field.](/docs/resources/foundry/ai-fde/ai-fde-mode-selector.png) <br><br>
* Add context manually from the ribbon above the prompt input field. You can add documentation bundles that are relevant to the task you want AI FDE to perform or upload media. You can also select the following Foundry resources:
  ...
  * Action types
  * Object types <br><br>
    ![The ribbon above the AI FDE input field with the option to add documentation bundles highlighted.](/docs/resources/foundry/ai-fde/ai-fde-ribbon-tool-options.png) <br><br>
...
![The tools menu below the prompt input field.](/docs/resources/foundry/ai-fde/ai-fde-tools-menu.png)
...
![The option to reject or allow tool usage in an AI FDE session.](/docs/resources/foundry/ai-fde/ai-fde-tool-approval.png)
