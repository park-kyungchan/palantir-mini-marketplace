---
sourceUrl: "https://www.palantir.com/docs/foundry/assist/agents-in-aip-assist/"
canonicalUrl: "https://palantir.com/docs/foundry/assist/agents-in-aip-assist/"
sourceLastmod: "2026-05-12T17:06:26.146Z"
fetchedAt: "2026-05-12T23:57:50.244Z"
fetcher: "palantir-mini import-palantir-official-docs"
extractor: "next-data-markdown"
contentHash: "0c890d60b74c4abb6b6282f38711eb6cf19f03bd5f4a0988786b3439b2c28a17"
product: "foundry"
docsArea: "assist"
locale: "en"
upstreamTitle: "Documentation | Power AIP Assist with custom content sources > Deploy custom source-backed AIP Chatbots"
licenseNote: "Local evidence mirror of public Palantir documentation. Use for routing and citation; do not republish as a standalone corpus."
---
# Deploy AIP Chatbots to AIP Assist

Serving custom content sources with AIP Assist dramatically expands the application assistance available to users. This feature also integrates with [AIP Chatbot Studio](/docs/foundry/chatbot-studio/overview/) (formerly AIP Agent Studio), allowing users to set up dedicated LLM-powered assistants, which use custom content sources, context from the Ontology or tools such as [functions](/docs/foundry/functions/overview/). Developers can now create custom-made assistants, without coding or LLM expertise.
...
To understand this feature, familiarize yourself with the concept of an AIP Chatbot and the [AIP Chatbot Studio](/docs/foundry/chatbot-studio/overview/) application:

**AIP Chatbots:** Interactive, LLM-powered assistants equipped with enterprise-specific information and tools.

**AIP Chatbot Studio:** Allows users to build no-code AIP Chatbots and deploy them internally in the Palantir platform and externally with our [OSDK](/docs/foundry/developer-console/deploy-custom-application-on-foundry/).
...
For this tutorial, we will explore the first option. For more information on this functionality refer to [register content sources with AIP Assist](/docs/foundry/assist/aip-assist-registering-content/).
...
![Inventory Management Application Documentation](/docs/resources/foundry/assist/aip-assist-notepad-document-example.png)

2. Make sure to organize your content into headings and subsections. Having a heading structure significantly improves the accuracy of responses, as content is segmented based on headings. Refer to the [custom content source best practices](/docs/foundry/assist/custom-documentation-best-practices/) for more information.
...
![The “Add to AIP Assist” option in the Notepad actions dropdown menu.](/docs/resources/foundry/assist/aip-assist-add-notepad-docs.png)
...
![Configure the "Add to AIP Assist" menu.](/docs/resources/foundry/assist/add-document-to-assist-configuration.png)
...
1. Navigate to the [AIP Chatbot Studio](/docs/foundry/chatbot-studio/overview/) application and select **+ New AIP Chatbot.**
...
![Configure the AIP Chatbot Name and Location.](/docs/resources/foundry/assist/aip-chatbot-new-name-location.png)
...
3. After saving the chatbot, you will be redirected to the AIP Chatbot Studio editor. Navigate to the **Chatbot configuration** section, and under **Retrieval context** select **Custom documentation context** and choose your previously indexed document. If it does not appear in the list, go back to step one and ensure that you added it to AIP Assist. You can choose many different documents to serve as the search context for your AIP Chatbot. See [AIP Chatbot Studio documentation](/docs/foundry/chatbot-studio/overview/) for more information on other AIP Chatbot features.

![Add context to AIP Chatbot.](/docs/resources/foundry/assist/aip-chatbot-documentation-context.png)
...
![Configure Model and System Prompt.](/docs/resources/foundry/assist/aip-chatbot-system-prompt.png)
...
![Publish AIP Chatbot.](/docs/resources/foundry/assist/aip-agent-publish.png)

6. Make the chatbot available for use in AIP Assist. To do this, open the **Usage** section, and enable the **AIP Assist** toggle.

![Deploy AIP Chatbot.](/docs/resources/foundry/assist/aip-chatbot-deploy.png)
...
![Select AIP Chatbot from Modes selector.](/docs/resources/foundry/assist/aip-assist-chatbot-mode-selector.png)

2. Select your chatbot and fire off your first question!

![First AIP Chatbot Response.](/docs/resources/foundry/assist/aip-assist-agent-response-v2.png)
