---
source: https://www.palantir.com/docs/apollo/core/supported-browsers
fetched: 2026-04-20
section: security-deployments
doc_title: supported-browsers
---
...
[Documentation](/docs/apollo/core/introduction/)[Supported browsers](/docs/apollo/core/supported-browsers/)

Supported browsers
==================

Apollo is fully supported on any version of the following desktop browsers released within the past year:

* Google Chrome
* Microsoft Edge

Older browser versions are partially supported up to the past two years, and browser versions released over two years ago are unsupported.
...
PREVIOUSHow Apollo works](/docs/apollo/core/how-apollo-works/)

[NEXTWhat's new

→](/docs/apollo/core/whats-new/)
