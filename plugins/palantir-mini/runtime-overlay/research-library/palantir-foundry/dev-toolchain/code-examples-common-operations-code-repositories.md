---
source: https://www.palantir.com/docs/foundry/code-examples/common-operations-code-repositories
fetched: 2026-04-20
section: dev-toolchain
doc_title: Common Operations (Code Repositories)
---
...
Code examplesCommon operations[Code Repositories](/docs/foundry/code-examples/common-operations-code-repositories/)
...
PREVIOUSGraph and tree structured datasets / Functions on Objects](/docs/foundry/code-examples/graph-and-tree-structured-datasets-functions-on-objects/)

[NEXTTransforms

→](/docs/foundry/code-examples/common-operations-transforms/)
