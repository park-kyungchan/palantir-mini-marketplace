---
source: https://www.palantir.com/docs/foundry/aip-evals/ontology-edits/
fetched: 2026-04-20
section: aip-stack
doc_title: Evaluate Ontology edits
---
...
When adding evaluation functions in the Evaluations application, you will be prompted to either author a function in Code Repositories or select an existing published function.
...
For object edit output types, the edited object already exists in the real Ontology. In the simulated Ontology, you can pass it directly into the function and check its properties:
