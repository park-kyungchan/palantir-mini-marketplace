...
const PLUGIN_SKILLS: ReadonlyArray<{
  ...
  { slug: "pm-portable-bundle",         description: "Create portable plugin tarball for cross-machine rehydration" },
  ...
  { slug: "pm-rehydrate",               description: "Rehydrate plugin from portable bundle on fresh machine" },
  ...
  { slug: "pm-restore",                 description: "Restore palantir-mini state from previous bundle" },
