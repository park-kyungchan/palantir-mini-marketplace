...
source-author: Prithvi Rajasekaran
source-published: 2026-03-24
...
topic: "Harness design for long-running application development — three-agent (planner/generator/evaluator) GAN-inspired architecture for multi-hour autonomous full-stack coding sessions"
---

# Harness design for long-running application development

> Published Mar 24, 2026 by Prithvi Rajasekaran, Anthropic Labs.
> Source: https://www.anthropic.com/engineering/harness-design-long-running-apps
> Cited by `~/.claude/rules/CONTEXT.md §15 Glossary` (3-agent task-specific harness species) and rule 16 v3.1.0+ §Roles ("Lead does NOT grade — self-grading bias is architectural") as the **task-specific harness species** 1차 자료. The Generator/Evaluator separation is the structural anchor for palantir-mini-sprint-harness's exclusion of self-grading.
...
> *(Original article includes video clip demonstrating the 3D museum room generation.)*
...
> *(Original article includes video clip demonstrating the DAW prompted via natural language.)*
...
- This is the canonical Anthropic source for the **3-agent task-specific harness species** taxonomy entry in `~/.claude/rules/CONTEXT.md §15 Glossary` 5-species list (#3).
- The **GAN-inspired Generator/Evaluator** separation directly motivates rule 16 v3.1.0+ §Roles invariant: *"Lead does NOT grade. Self-grading bias is architectural (Prithvi 2026-03-24); structural separation eliminates it."*
- The **sprint contract** concept (generator + evaluator negotiate "what done looks like" before implementation) is the upstream pattern for palantir-mini's `negotiate_sprint_contract` MCP handler (rule 16 v3.2.0 §Loop step 1).
- The **file-based IPC** pattern (one agent writes, another reads) is the upstream pattern for rule 16 §File-based IPC: *"Generator ↔ Evaluator communicate ONLY via feedback-NNN.md ... Direct SendMessage between them is forbidden."*
- The **harness leniency principle** (every component encodes an assumption that may go stale) is also referenced in Lance Martin (2026-04-08) `scaling-managed-agents-2026-04-08.md` — the two posts share this thesis.
- Companion to: Justin Young (2025-11-26) `effective-harnesses-2025-11-26.md` + Lance Martin (2026-04-08) `scaling-managed-agents-2026-04-08.md`.
