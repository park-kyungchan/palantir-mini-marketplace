---
source: https://www.palantir.com/docs/foundry/code-examples/functions-on-objects-functions-on-objects
fetched: 2026-04-20
section: dev-toolchain
doc_title: Functions on Objects (Functions on Objects)
---
...
Code examplesFunctions on objects[Functions on Objects](/docs/foundry/code-examples/functions-on-objects-functions-on-objects/)
...
PREVIOUSRaw file parsing / Transforms](/docs/foundry/code-examples/raw-file-parsing-transforms/)

[NEXTDataset metadata operations / Code Repositories

→](/docs/foundry/code-examples/dataset-metadata-operations-code-repositories/)
