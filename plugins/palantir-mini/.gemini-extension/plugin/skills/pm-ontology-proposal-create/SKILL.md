...
description: "Create an OntologyProposalDeclaration (or GlobalBranchingProposal v1.40+) from a branch — packages affected resources + reviewers + validation summary for cross-app review."
