...
// registered AS an ObjectType + 10 agent instances. Proves the self-model gains the
...
test("Agent seed identity set matches the LIVE agents/ directory (drift guard)", () => {
  ...
  // agents/ directory and asserts the self-model's 10 agentIds equal pm's actual agent
