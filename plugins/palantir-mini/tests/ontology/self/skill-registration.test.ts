...
// AS an ObjectType + 39 skill instances. Proves the self-model gains the Skill noun and
...
test("Skill seed matches the LIVE skills/ directory surface (drift guard)", () => {
  ...
  // skills/ directory and asserts the self-model's 39 slugs equal pm's actual skill
