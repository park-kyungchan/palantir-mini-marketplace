...
export const MCP_TOOL_CAPABILITIES: readonly McpToolCapability[] = [
  ...
  capability("pm_surface_contract_audit", {
    domain: "GOVERNANCE",
    effects: ["validate"],
    mutationKind: "none",
    requiresDtcApproval: false,
    ...
    releaseDeploy: false,
    externalEgress: false,
    classifierProjection: explicit("pm_surface_contract_audit"),
  }),
  capability("pm_aip_source_authority_validate", {
    domain: "GOVERNANCE",
    effects: ["validate"],
    mutationKind: "none",
    requiresDtcApproval: false,
    ...
    releaseDeploy: false,
    externalEgress: false,
    classifierProjection: explicit("pm_aip_source_authority_validate"),
  }),
  capability("pm_runtime_decision_parity", {
    domain: "GOVERNANCE",
    effects: ["evaluate"],
    mutationKind: "none",
    requiresDtcApproval: false,
    ...
    releaseDeploy: false,
    externalEgress: false,
    classifierProjection: explicit("pm_runtime_decision_parity"),
  }),
