...
> Runtime-boundary migration note (2026-05-24): this document describes the compatibility shim path. Target ownership for Codex hook adapter protocol logic is `~/.codex/**`; durable workflow semantics and hook intent remain in the canonical source root at `/home/palantirkc/palantir-mini` and the neutral boundary at `/home/palantirkc/.palantir-mini/core/runtime-boundary/runtime-boundary-contract.json`.
...
source root at `/home/palantirkc/palantir-mini/hooks/hooks.json`. Legacy plugin-
...
Codex runtime
  → ~/.codex/hooks/palantir-mini-claude-hook-adapter.ts  (thin shim — THIS file)
      → ~/.codex/lib/palantir-mini/native-hook-adapter.ts  (Codex-native protocol owner)
          → /home/palantirkc/palantir-mini/hooks/hooks.json  (canonical hook intent registry)
```
...
`/home/palantirkc/palantir-mini/` is the canonical source of truth for
...
- **Required**: All runtimes consume durable workflow semantics from `/home/palantirkc/palantir-mini` through their native adapter/bridge.
 ...
 *
 * AUTO-GENERATED from /home/palantirkc/palantir-mini/hooks/hooks.json
 * — see scripts/sync-codex-adapter.ts; DO NOT EDIT BY HAND
 * Generated at: <ISO8601 timestamp>
 * Source authority: /home/palantirkc/palantir-mini
 * ...
```
...
"forbiddenForks": [
  ...
  "All runtimes share durable workflow semantics from /home/palantirkc/palantir-mini/.",
...
- `/home/palantirkc/palantir-mini/hooks/hooks.json` — the live SSoT hook intent registry.
